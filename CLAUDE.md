...
src/
  ...
  renderer/
    ...
    threadView.ts                      ← Pure: thread kind/state/title, threadFolderTarget, insertNewThread, projectLookChanges, applyProjectLook, threadName, model label, foldThreads, counter pills, kindWord, runningLabel, needsCloseConfirm, needsSleepConfirm, threadState, projectCounts, threadFolder. Unit-tested.
